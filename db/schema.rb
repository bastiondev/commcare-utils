...
ActiveRecord::Schema[8.1].define(version: 2026_05_13_145100) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  create_table "destination_sources", force: :cascade do |t|
    t.string "case_type"
    ...
    t.index ["destination_id", "name"], name: "index_destination_sources_on_destination_id_and_name", unique: true
    t.index ["destination_id"], name: "index_destination_sources_on_destination_id"
  end

  create_table "destination_tokens", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "destination_id", null: false
    t.datetime "last_accessed_at"
    t.string "token", null: false
    t.datetime "updated_at", null: false
    t.index ["destination_id"], name: "index_destination_tokens_on_destination_id"
    t.index ["token"], name: "index_destination_tokens_on_token", unique: true
  end
